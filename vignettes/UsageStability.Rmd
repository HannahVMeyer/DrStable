...
Y <- lapply(alpha, function(a) {
    simulation <- PhenotypeSimulator::runSimulation(N=1000, P=50,
                           tNrSNP=10000, SNPfrequencies=c(0.05, 0.1,0.3,0.4),
                           genVar=0.4, h2s=0.05, h2bg=0.95, phi=0.6, seed=a*10,
                           delta=0.4, nonlinear="exp", proportionNonlinear=a)
